    ...
    <script>
        ...
        function openStatus() {
            ...
            if (flag) {
                ...
                form.action = "${pageContext.request.contextPath}/product/open";
                form.submit();
            }
        ...
        function closeStatus() {
            ...
            if (flag) {
                var form = document.getElementById("form");
                form.action = "${pageContext.request.contextPath}/product/close";
                form.submit();
            }
        ...
        function query() {
            var form1 = document.getElementById("form1").submit();
        }
    </script>
</head>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="删除"
                                            onclick="location.href='javaScript:deleteProduct()'">
                                        <i class="fa fa-trash-o"></i> 删除
                                    </button>
                                    <button type="button" class="btn btn-default" title="开启"
                                            onclick="location.href='javaScript:openStatus()'">
                                        <i class="fa fa-check"></i> 开启
                                    </button>
                                    <button type="button" class="btn btn-default" title="屏蔽"
                                            onclick="location.href='javaScript:closeStatus()'">
                        ...
                        <form id="form1" action="${pageContext.request.contextPath}/product/findAll?pageSize=${pageInfo.pageSize}">
                        <div class="box-tools pull-right">
                            <div class="has-feedback">
                                <input type="text" class="form-control input-sm"
                                       placeholder="搜索" name="productName" value="${product.productName}" ondblclick="location.href='javaScript:query()'"/>
                                <span
                        ...
                        <form id="form" action="${pageContext.request.contextPath}/product/delete">
                            <table id="dataList"
                        ...
                        <ul class="pagination">
                            ...
                            <c:forEach begin="1" end="${pageInfo.pages}" var="i">
                                <c:if test="${pageInfo.pageNum==i}">
                                    <li class="active"><a href="${pageContext.request.contextPath}/product/findAll?pageNum=${i}&pageSize=${pageInfo.pageSize}">${i}</a></li>
                                </c:if>
                                <c:if test="${pageInfo.pageNum!=i}">
                                    <li ><a href="${pageContext.request.contextPath}/product/findAll?pageNum=${i}&pageSize=${pageInfo.pageSize}">${i}</a></li>
                                </c:if>
                            </c:forEach>
