				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<form id="form1" action="${pageContext.request.contextPath}/orders/findAll">
							<div class="box-tools pull-right">
								<div class="has-feedback">
									<input type="text" class="form-control input-sm"
										placeholder="搜索" name="orderNum" value="${orders.orderNum}" ondblclick="location.href='javaScript:query()'"> <span
                        ...
                        <ul class="pagination">
                            ...
                            <c:forEach begin="1" end="${pageInfo.pages}" var="i">
                                <c:if test="${pageInfo.pageNum==i}">
                                    <li class="active"><a href="${pageContext.request.contextPath}/orders/findAll?pageNum=${i}&pageSize=${pageInfo.pageSize}">${i}</a></li>
                                </c:if>
                                <c:if test="${pageInfo.pageNum!=i}">
